...
const ProjectStatus = styled.div`
  ...
  background-color: ${props => props.theme.colors.accentPurple}33;
  color: ${props => props.theme.colors.accentPurple};
  border-radius: 12px;
  font-weight: 500;
  margin-top: 0.5rem;
        ...
        <ProjectsGrid>
          {projects.map((project) => (
            <ProjectCard key={project.id}>
              <ProjectImage>
                <img
                  src={project.imgSrc?.src || "/images/placeholder.png"}
                  alt={project.title}
                />
                <ProjectOverlay>
                  <ProjectLinks>
              ...
              <ProjectContent>
                ...
                <ProjectStatus>{project.status || project.Status}</ProjectStatus>
              </ProjectContent>
            </ProjectCard>
          ))}
        </ProjectsGrid>
